class Barchart2 {
  ...
  constructor(_config, _data, _graphData) {
    ...
    this.config = {
      ...
      margin: _config.margin || {top: 30, right: 150, bottom: 25, left: 50},
  ...
  initVis() {
    ...
    vis.colorPalette = d3.scaleOrdinal()
        .range(['#AED6F1','#85C1E9','#5DADE2', '#3498DB' ,'#2E86C1' ,'#2874A6', '#21618C', '#1B4F72'])
